...
public class T4Activity extends Activity{
	...
	{
		getListgetInfoList(Integer.toString(curPage), "3", "0", time, new VolleyDataCallback() {
        	@Override
    ...
    public void getMoreData()
    {
    	 ...
    	 getListgetInfoList(String.valueOf(curPage), "3", "0", "0", new VolleyDataCallback() {
         	@Override
     		public void onSuccess(A_ListBean bean) {
