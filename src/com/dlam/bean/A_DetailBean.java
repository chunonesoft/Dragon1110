...
public class A_DetailBean {
	...
	private String type1icon;
	private String type1id;
	private String type1name;
	private String type2icon;
	...
	public String getType1icon() {
		return type1icon;
	}
	public void setType1icon(String type1icon) {
		this.type1icon = type1icon;
	}
	...
	public String getType2icon() {
		return type2icon;
	}
	public void setType2icon(String type2icon) {
		this.type2icon = type2icon;
	}
