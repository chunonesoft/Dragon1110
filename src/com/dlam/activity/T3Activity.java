...
public class T3Activity extends Activity{
	...
	private A_ListBean ResponseData;
	private String URL;
	...
	{
		getListgetInfoList(Integer.toString(curPage), "2", "0", time, new VolleyDataCallback() {
        	@Override
    ...
    public void getMoreData()
    {
    	 ...
    	 getListgetInfoList(String.valueOf(curPage), "1", "0", "0", new VolleyDataCallback() {
         	@Override
     		public void onSuccess(A_ListBean bean) {
         		System.out.println("网络当前页数"+bean.getCurrentpage());
         		List<infolist> dataBean = new ArrayList<infolist>();
         		dataBean = bean.getInfolist();
         		for(int i = 0;i < dataBean.size();i++)
         		{
         			datas.add(dataBean.get(i));
         			System.out.println(i+"title----------"+dataBean.get(i).getTitle());
         		}
    ...
    public void getUpdateData()
    {
    	...
    	getListgetInfoList(Integer.toString(curPage), "1", "0", time, new VolleyDataCallback() {
         	@Override
     		public void onSuccess(A_ListBean bean) {
